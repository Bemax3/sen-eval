...
class ClaimsDetailsExport implements FromCollection, WithHeadings, WithMapping, ShouldAutoSize, WithStyles, WithDefaultStyles
{
    ...
    {
        return getClaimsDetails($this->phase_id, $this->org_id, $this->type->claim_type_id)->with('rating', 'rating.evaluated', 'rating.evaluator')->get();
    }
