...
import {parseDate} from "@/helpers/helper.js";
...
<template>
    <SwitchGroup as="div" class="flex items-center justify-between">
        ...
        <Switch v-model="enabled" :class="[enabled ? 'bg-cyan-600' : 'bg-gray-200', 'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-cyan-600 focus:ring-offset-2']" :disabled="disabled">
