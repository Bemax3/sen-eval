...
<template>
    <Switch v-model="enabled"
        ...
        <span
            :class="[enabled ? 'translate-x-5' : 'translate-x-0', 'pointer-events-none relative inline-block h-5 w-5 transform rounded-full bg-white dark:bg-grayish shadow ring-0 transition duration-200 ease-in-out']">
      <span
