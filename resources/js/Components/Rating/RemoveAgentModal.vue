...
const destroy = () => {
    router.put(route('agents.update', {agent: idToDelete.value}))
}
                        ...
                        <DialogPanel
                            ...
                            <div class="sm:flex sm:items-start">
                                ...
                                <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                    ...
                                    <div class="mt-2">
                                        <p class="text-sm text-gray-500 dark:text-gray-100">Êtes vous sûre de vouloir continuer ? Vous aller retirer cet agent de votre
                                            liste.</p>
                                    </div>
                                </div>
                            </div>
