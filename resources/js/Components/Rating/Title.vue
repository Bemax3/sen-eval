        ...
        <div class="sm:flex-auto">
            <div class="flex justify-between items-center">
                <div class="sm:flex sm:justify-between sm:items-center gap-2">
                    ...
                    <p
                        :class="color === 'red' ? 'bg-red-600 ring-red-600/20' : (color === 'amber' ? 'bg-amber-600 ring-amber-600/20' : (color === 'green' ? 'bg-green-600 ring-green-600/20' : 'bg-fuchsia-600 ring-fuchsia-600/20'))"
                ...
                <span class="flex-shrink-0">
                    <span
                        :class="color === 'red' ? 'border-red-600' : (color === 'amber' ? 'border-amber-600' : (color === 'green' ? 'border-green-600' : 'border-fuchsia-600'))"
                        class="flex h-20 w-20 items-center justify-center rounded-full border-4">
                        <span
                            :class="color === 'red' ? 'text-red-600' : (color === 'amber' ? 'text-amber-600' : (color === 'green' ? 'text-green-600' : 'text-fuchsia-600'))"
