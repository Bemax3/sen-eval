...
const validationForm = computed(() => useForm({
    validator_id: props.validation.validator_id,
    has_validated: true,
}))
...
const validate = () => {
    validationForm.value.put(route('validations.update', {
        validation: props.validation.rating_validator_id
    }), {
        onError: err => {
