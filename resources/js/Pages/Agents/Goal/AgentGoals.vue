...
import {ChevronDoubleRightIcon, EyeIcon, PlusIcon, TrashIcon} from "@heroicons/vue/20/solid/index.js";
...
<template>
	<AuthenticatedLayout>
		...
		<div class="px-4 sm:px-6 lg:px-8">
			...
			<div class="sm:flex sm:items-center">
				<div class="sm:flex-auto">
					<SectionTitle desc="Cette liste représente les objectifs fixés á cet agent." title="Objectifs de l'agent"/>
				</div>
				<div class=" space-x-2 mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
					<Link
