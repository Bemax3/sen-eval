...
const commentForm = useForm({evaluator_comment: props.rating.evaluator_comment || ''})
const searchAgent = reactive({keyword: '', fields: ['user_matricule', 'user_display_name']});
const n2 = useForm({
	validator_id: props.n1 ? props.n1.user_id : hasData(props.others) ? props.others[0].user_id : null,
	remember: true,
		...
		<div class="px-4 sm:px-6 lg:px-8">
			...
			<div role="list">
				<div class="px-4 py-4 sm:px-0">
					<div class="pr-4 py-5 sm:pr-6 bg-white mb-4 px-5 rounded-lg shadow">
					...
					<div class="grid grid-cols-2 gap-2">
						<div class="px-4 py-5 sm:p-6">
							...
							<div class=" mt-3 flex items-center">
								<input id="remember-n1" v-model="n2.remember" class="h-4 w-4 rounded border-gray-300 text-cyan-600 focus:ring-cyan-600"
								       name="remember-n1"
								       type="checkbox"/>
