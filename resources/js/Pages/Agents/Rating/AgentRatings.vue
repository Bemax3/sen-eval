...
<template>
    <AuthenticatedLayout>
        ...
        <div class="px-4 sm:px-6 lg:px-8">
            ...
            <Datatable :pagination="pagination" v-if="hasData(ratings.data)" v-model="search.keyword">
                    ...
                    <tr v-for="e in displayedData" :key="e.evaluation_id">
                        ...
                        <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                            <div class="flex items-center justify-center">
                                <Link :href="route('agent-ratings.show', {agent: agent.user_id,agent_rating: e.rating_id})" class="group flex items-center px-4 py-2 text-sm">
