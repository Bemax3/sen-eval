                                    ...
                                    <Listbox v-model="form.phase_id" as="div">
                                        <div class="relative mt-2">
                                            <ListboxButton
                                                ...
                                                class="relative w-full cursor-default rounded-md bg-white py-1.5 pl-3 pr-10 text-left text-gray-900 shadow-sm ring-1 ring-inset focus:outline-none focus:ring-2 focus:ring-cyan-600 sm:text-sm sm:leading-6">
