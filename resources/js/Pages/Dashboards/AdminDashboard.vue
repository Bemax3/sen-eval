...
import {ChevronRightIcon, ChevronUpDownIcon} from "@heroicons/vue/20/solid/index.js";
...
const stats = [
	{id: 1, name: 'Total des Agents', stat: props.users, icon: UsersIcon},
	{id: 2, name: 'Évaluations validées', stat: props.rated, icon: CheckIcon},
	{id: 3, name: 'Évaluations non validées', stat: props.not_validated, icon: ExclamationCircleIcon},
	{id: 4, name: 'Non évalués', stat: props.not_rated, icon: XMarkIcon},
]
...
const filterDashboard = () => {
	router.get(route('admin-dashboard.index', {phase_id: form.phase_id, org_id: form.org_id, selected: selectedTab.value.id}))
}
		...
		<div class="px-4 sm:px-6 lg:px-8">
			...
			<template v-if="selectedTab.id === 1">
				<template v-if="trainings.length > 0">
					<h3 class="text-base font-semibold leading-6 text-gray-900 mt-8">
