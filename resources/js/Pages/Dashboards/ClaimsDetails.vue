...
const pages = [{
    ...
    current: false
}, {name: 'Détails des Réclamations demandées', href: '#', current: true}]
        ...
        <div class="px-4 sm:px-6 lg:px-8">
            ...
            <div class="sm:flex sm:items-center">
                <div class="sm:flex-auto">
                    <h1 class="text-2xl font-semibold leading-6 text-gray-900 dark:text-white">Réclamation du type "{{ type.claim_type_name }}" pour l'année
                        {{ phase.phase_year }}
                ...
                <div v-if="displayedData.length > 0" class=" space-x-2 mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                    <a
                        :href="route('admin-dashboard.download-claims-details',{org_id: org.org_id, phase_id: phase.phase_id,type: type.claim_type_id})"
            ...
            <Datatable v-if="hasData(claims.data)" v-model="search" :pagination="pagination" :search="false">
                <table v-if="displayedData.length > 0" class="min-w-full divide-y divide-gray-300 dark:divide-black">
                    ...
                    <tr v-for="claim in displayedData" :key="claim.rating_claim_id">
                        <TableData :first="true" class="whitespace-pre-line">{{ type.claim_type_name }}</TableData>
