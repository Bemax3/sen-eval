        ...
        <div class="px-4 sm:px-6 lg:px-8">
            ...
            <div class="sm:flex sm:items-center">
                <div class="sm:flex-auto">
                    <h1 class="text-2xl font-semibold leading-6 text-gray-900 dark:text-white">Sanction du type "{{ type.sanction_type_name }}" pour l'année
                        {{ phase.phase_year }}
                ...
                <div v-if="displayedData.length > 0" class=" space-x-2 mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                    <a
                        :href="route('admin-dashboard.download-sanctions-details',{org_id: org.org_id, phase_id: phase.phase_id,type: type.sanction_type_id})"
