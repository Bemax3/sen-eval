...
const commentForm = useForm({
    evaluator_comment: props.evaluation.evaluator_comment || '',
})
                ...
                <form class="mt-8 bg-white shadow-xl sm:rounded-lg" @submit.prevent="submitEval">
                    <div class="grid grid-cols-2 gap-2">
                        ...
                        <div class="px-4 py-5 sm:p-6">
                            ...
                            <div class="mt-2 max-w-xl text-sm text-gray-500">
                                <p>Commentaire de {{evaluation.evaluated.user_display_name}}</p>
                            </div>
                            <div class="mt-5 sm:flex sm:items-center">
                                <div class="w-full sm:max-w-xl">
                                    <div class="col-span-full">
                                        ...
                                        <div class="relative mt-2">
                                            <TextArea :disabled="true" v-model="evaluation.evaluated_comment" />
