...
<template>
    <AuthenticatedLayout>
        ...
        <div class="px-4 sm:px-6 lg:px-8">
            ...
            <form v-if="!isValidator" class="mt-8 bg-white px-4 py-5 sm:p-6 shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-2" @submit.prevent="submit">
                    ...
                    <tr v-for="mobility in displayedData" :key="mobility.rating_mobility_id">
                        ...
                        <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                            <div class="flex items-center justify-center space-x-2">
                                <button v-if="(isEvaluated && mobility.asked_by_evaluated) || (!isEvaluated && mobility.asked_by_evaluator)"
                                        class="rounded-lg bg-cyan-600 p-2 text-white shadow-sm hover:bg-cyan-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-600" type="button"
