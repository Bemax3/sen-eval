...
<template>
    <AuthenticatedLayout>
        ...
        <div class="px-4 sm:px-6 lg:px-8">
            ...
            <div v-if="!isEvaluated && !isValidator" class="mt-8 bg-white shadow sm:rounded-lg">
                <div class="px-4 py-5 sm:p-6">
                    ...
                    <form class="mt-5 sm:flex sm:items-center" @submit.prevent="submit">
                        ...
                        <SubmitButton class="sm:ml-3 sm:mt-0 sm:w-auto" type="submit">Demander</SubmitButton>
                    </form>
                </div>
            </div>
