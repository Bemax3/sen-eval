...
<template>
    <AuthenticatedLayout>
        ...
        <div class="px-4 sm:px-6 lg:px-8">
            ...
            <div v-if="!isValidator" class="mt-8 bg-white shadow sm:rounded-lg">
                    ...
                    <tr v-for="training in displayedData" :key="training.rating_training_id">
                        ...
                        <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                            <div class="flex items-center justify-center">
                                <button v-if="(isEvaluated && training.asked_by_evaluated) || (!isEvaluated && training.asked_by_evaluator)"
