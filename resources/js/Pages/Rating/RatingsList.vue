...
const pages = [{name: 'Mes Évaluations', href: '#', current: true}]
        ...
        <div class="px-4 sm:px-6 lg:px-8">
            ...
            <div class="sm:flex sm:items-center">
                <div class="sm:flex-auto">
                    <h1 class="text-2xl font-semibold leading-6 text-gray-900 dark:text-white">Mes Évaluations</h1>
                    <p class="mt-2 text-sm text-gray-700 dark:text-white">
                        Liste de mes Évaluations.
                    </p>
                </div>
            </div>
