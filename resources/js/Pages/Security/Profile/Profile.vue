...
const submitForm = () => {
    form.put(route('profile.update', {profile: props.user.user_id}));
}
                    ...
                    <form class="md:col-span-2">
                        <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:max-w-xl sm:grid-cols-6">
                            <div class="col-span-full flex items-center gap-x-8">
                                <img alt="" class="h-24 w-24 flex-none rounded-lg bg-cyan-700 object-cover" src=""/>
                            </div>
                ...
                <div class="grid max-w-7xl grid-cols-1 gap-x-8 gap-y-10 px-4 py-16 sm:px-6 md:grid-cols-3 lg:px-8 border-t-2">
                    ...
                    <form class="md:col-span-2" @submit.prevent="submitForm">
                        <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:max-w-xl sm:grid-cols-6">
                            ...
                            <div class="col-span-full">
                                <label class="block text-sm font-medium leading-6 text-gray-900" for="confirm-password">Organisation</label>
                                <div class="relative shadow-sm rounded-md mt-2">
