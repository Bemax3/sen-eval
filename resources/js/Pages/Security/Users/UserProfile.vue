...
const pages = [{name: 'Profil', href: '#', current: true}]
const form = useForm({
...
const data = setData();
const submitForm = () => form.put(route('users.update', {user: props.user.user_id}));
const getFromDb = () => {
            ...
            <div class="mt-8 shadow ring-1 ring-black ring-opacity-5 sm:rounded-lg bg-white dark:bg-grayish">
                ...
                <div class="grid max-w-7xl grid-cols-1 gap-x-8 gap-y-10 px-4 py-16 sm:px-6 md:grid-cols-3 lg:px-8 border-t-2">
                    ...
                    <form class="md:col-span-2" @submit.prevent="submitForm">
                        <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:max-w-xl sm:grid-cols-6">
                            <div class="col-span-full">
                                <label class="block text-sm font-medium leading-6 text-gray-900 dark:text-white" for="confirm-password">Organisation</label>
                                <div class="relative shadow-sm rounded-md mt-2">
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="relative shadow-sm rounded-md mt-2">
                                    <input
                                        ...
                                        class="bg-white dark:bg-grayish block w-full rounded-md border-0 py-1.5 text-gray-900 dark:text-white shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset  sm:text-sm sm:leading-6"/>
                                    <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-3">
                                        <LockClosedIcon aria-hidden="true" class="h-5 w-5 text-gray-400"/>
                                    </div>
                                </div>
