...
const pages = [{name: 'Compétences', href: '#', current: true}]
const pagination = computed(() => getPagination(props.skills));
const openModal = ref(false);
const displayedData = ref(props.skills.data);
const search = reactive({keyword: '', fields: ['skill_name', 'skill_desc']});
                        ...
                        <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                            <div class="flex items-center justify-center">
                                <Link
                                    ...
                                    <PencilSquareIcon
                                        aria-hidden="true"
                                        class="mr-3 h-5 w-5 text-gray-400 group-hover:text-s-pink-600"/>
                                </Link>
                            </div>
                        </td>
                    </tr>
