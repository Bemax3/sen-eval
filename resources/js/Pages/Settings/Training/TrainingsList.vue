                    ...
                    <tr v-for="training in displayedData" :key="training.training_type_id">
	                    ...
	                    <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                            <div class="flex items-center justify-center">
                                <Link :href="route('trainingTypes.edit',{trainingType: training.training_type_id})" class="group flex items-center px-4 py-2 text-sm">
                                    <PencilSquareIcon class="mr-3 h-5 w-5 text-gray-400 group-hover:text-cyan-600" aria-hidden="true" />
                                </Link>
                                <a href="#" @click="destroy(training.training_type_id)" class="group flex items-center px-4 py-2 text-sm">
