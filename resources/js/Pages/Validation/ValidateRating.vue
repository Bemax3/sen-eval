                ...
                <div class="mt-8 bg-white shadow sm:rounded-lg">
                    <form @submit.prevent="save">
                        ...
                        <div class="flex items-center justify-between gap-x-6 border-t border-gray-900/10 px-4 py-4 sm:px-8">
                            <FormIndications/>
                            <div>
                                <SubmitButton :disabled="rating.rating_is_validated || validation.has_validated || !evaluatedValidation.has_validated"
                                ...
                                <button
                                    :class="rating.rating_is_validated || validation.has_validated || !evaluatedValidation.has_validated ? 'bg-gray-600' : 'bg-cyan-600  focus-visible:outline-cyan-600 hover:bg-cyan-700    '"
                                    :disabled="rating.rating_is_validated || validation.has_validated || !evaluatedValidation.has_validated"
