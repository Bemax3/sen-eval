...
class ModelSearchAspect extends SearchAspect
{
    ...
    public function addMixedSearchableAttribute(string $attribute): self
    {
        $this->attributes[] = SearchableAttribute::createMixed($attribute);
            ...
            foreach (Arr::wrap($attributes) as $attribute) {
                ...
                foreach ($searchTerms as $searchTerm) {
                    ...
                    $attribute->isPartial()
                        ...
                        : ($attribute->isMixed() ? $query->orWhereRaw($sql, ["{$searchTerm}%", '\\'])
